...
function transferPayToBank(){
    ...
    return document.getElementById("balance").innerHTML = balance;
...
function getLoan(){
    if (isRepayLoan == false){
            ...
            do {//I want to do this until the user adds a correct loan amount.
            ...
            if ((loanInput) <= (balance * 2)) { //If the loan input is acceptable then we will be adding it to the outstanding loan.
...
function repayLoan(){
    if (pay < outstandingLoan){
        ...
        outstandingLoan = document.getElementById("outstandingLoan").innerHTML;
        pay -= outstandingLoan;
        console.log(pay);
        outstandingLoan = 0;
        setPay();
        return document.getElementById("outstandingLoan").innerHTML = outstandingLoan;       
    }
